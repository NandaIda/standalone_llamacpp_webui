...
{:else if isServerLoading}
	...
	<ServerLoadingSplash />
{:else if serverStore.error && !serverStore.modelName && !isExternalApi()}
	<ServerErrorSplash error={serverStore.error} />
{:else if serverStore.modelName || isExternalApi()}
	<div
	...
	>
		<div class="w-full max-w-[48rem] px-4">
			<div class="mb-8 text-center" in:fade={{ duration: 300 }}>
				<h1 class="mb-1 text-3xl font-semibold tracking-tight">WebUI</h1>
				<p class="mb-2 text-xs text-muted-foreground">modified from llama.cpp</p>
